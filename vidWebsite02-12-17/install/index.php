                    ...
                    <div class="col-md-6">
                        <form id="configurationForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="webSiteTitle" placeholder="Enter the title of your Web Site" value="Movief4u" required="required">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="databaseName" placeholder="Enter Database Name" value="Movief4u" required="required">
                            </div>
                            <div class="form-group">
