...
foreach ($videos as $key => $value) {
    ...
    ?>
    <div style="margin-top:2%" class="col-lg-2 col-sm-2 col-xs-2 bottom-border" itemscope itemtype="http://schema.org/VideoObject">
        ...
        ?>" title="<?php echo $value['title']; ?>" class="videoLink">
            <div class="col-lg-10 col-sm-10 col-xs-10 nopadding thumbsImage" >
                <?php
                $imgGif = "";
                ...
                if ($value['type'] !== "audio") {
                    $img = "{$global['webSiteRootURL']}images/{$value['postername']}.jpg";
                ...
                ?>
                <img style="height:280px;width:180px" src="<?php echo $img; ?>" alt="<?php echo $value['title']; ?>" class="thumbsJPG img-responsive <?php echo $img_portrait; ?>  rotate<?php echo $value['rotation']; ?>" height="130px" />
                <?php
                if (!empty($imgGif)) {
                    ?>
                ...
                <?php } ?>
                <span itemprop="name" class="title"><?php echo $value['title']; ?></span>
                <span class="glyphicon glyphicon-play-circle"></span>
           <!--  for hqvid    <time class="duration" itemprop="duration" datetime="<?php echo Video::getItemPropDuration($value['duration']); ?>"><?php echo Video::getCleanDuration($value['duration']); ?></time>
            --> </div>
        <!--    for hqVid       
