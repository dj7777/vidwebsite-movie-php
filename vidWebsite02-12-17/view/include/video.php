...
<div class="row main-video">
    ...
    <div class="col-xs-12 col-sm-12 col-lg-8">
        <div id="videoContainer">
           ...
           <!--      <video poster="<?php echo $poster; ?>" controls crossorigin 
                    ...
                    <source src="<?php echo $playNowVideo['filename']; ?>" type="video/mp4">
 ...
 -->
<iframe id="vidFrame" src="<?php echo $playNowVideo['filename']; ?>" scrolling="no"
 frameborder="0" width="100%" height="430" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
