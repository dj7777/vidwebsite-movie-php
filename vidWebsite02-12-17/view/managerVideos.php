                    ...
                    formatters: {
                        ...
                        "titleTag": function (column, row) {
                            ...
                            if (row.type === "audio") {
                                ...
                                img = "<img class='img img-responsive " + is_portrait + " img-thumbnail pull-left rotate" + row.rotation + "' src='<?php echo $global['webSiteRootURL']; ?>images/" + row.postername + ".jpg'  style='max-height:80px; margin-right: 5px;'> ";
                            }
