                                            ...
                                            if (checkVideosDir()) {
                                                ...
                                                <div class="alert alert-danger">
                                                    ...
                                                    <details>
                                                        ...
                                                        if (!file_exists($dir)) {
                                                            ?>
                                                            The video directory does not exists, Movief4u had no permition to create it, you must create it manualy!
                                                            <br>
                                        ...
                                        <div class="tab-pane" id="tabAdvanced">
                                            ...
                                            if (empty($global['disableAdvancedConfigurations'])) {
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            ...
                                                            <small id="encoder_urlHelp" class="form-text text-muted">
                                                                ...
                                                                <?php echo __("You can use our public encoder on"); ?>: https://encoder.Movief4u.com/ or 
                                                                <a href="https://github.com/DanielnetoDotCom/Movief4u-Encoder" class="btn btn-default btn-xs" target="_blank"><?php echo __("For faster encode, download your own encoder"); ?></a>
                                                            </small>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-2"><?php echo __("Disable Movief4u Google Analytics"); ?></label>  
                                                        <div class="col-md-10">
