...
ALTER SCHEMA `Movief4u`  DEFAULT CHARACTER SET utf8  DEFAULT COLLATE utf8_general_ci ;
...
CHANGE COLUMN `webSiteTitle` `webSiteTitle` VARCHAR(45) NOT NULL DEFAULT 'Movief4u' ,
